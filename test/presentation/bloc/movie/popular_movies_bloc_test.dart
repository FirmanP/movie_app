...
void main() {
  ...
  final tMovieList = <Movie>[tMovieModel];
   ...
   blocTest<PopularMoviesBloc, PopularMoviesState>(
    'Should emit [Loading, HasData] when data is gotten successfully on GetPopularMovies',
    build: () {
   ...
   blocTest<PopularMoviesBloc, PopularMoviesState>(
    'Should emit [Loading, Error] when get search is unsuccessful on GetPopularMovies',
    build: () {
      when(mockGetPopularMovies.execute())
