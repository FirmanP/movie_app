...
void main() {
  ...
  blocTest<NowPlayingBloc, NowPlayingState>(
    'Should emit [Loading, HasData] when data is gotten successfully on GetNowPlaying',
    build: () {
   ...
   blocTest<NowPlayingBloc, NowPlayingState>(
    'Should emit [Loading, Error] when get search is unsuccessful on GetNowPlaying',
    build: () {
      when(mockGetNowPlayingMovies.execute())
